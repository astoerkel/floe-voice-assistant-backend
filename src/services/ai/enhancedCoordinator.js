...
class EnhancedLangChainCoordinator {
  constructor() {
    ...
    logger.info('Enhanced LangChain Coordinator initialized successfully');
  }
  ...
  async createAgentExecutor(userId) {
    try {
      ...
      const prompt = ChatPromptTemplate.fromMessages([
        ['system', `You are a helpful AI voice assistant with access to the user's calendar, email, and task management systems.
